    ...
    <div class="col-md-6">
      ...
      <div class="row align-items-center h-100">
        <div class="col ">
          ...
          <p style="font-size:17px; margin-top:20px; text-align:left;">We want to make a cloud compiler which runs the every language code at one platform.<br>
            We want to design that kind of website which is proved very helpful for people.
            <br /><br />
